...
This creates an account and opens up your dashboard. Click the `Domains` tab from your Mailgun dashboard. Copy your *Default SMTP Login* and *Default Password* to your `application.yml` file which was generated by figaro. Open up the [`mail.rb`](./config/initializers/mail.rb) included in this repo and change the domain to your deployed Heroku instance. You are all set to send out emails to your customers with Stripe generated coupons upon receiving their payments.
